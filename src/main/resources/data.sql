BEGIN TRANSACTION;
INSERT INTO "Colegiado" ("idColegiado","nombre","apellidos","direccion","poblacion","telefono","datosBancarios","fechaSolicitudColegiado","titulacion","centro","anioTitulo","dni","estadoCobro","fechaCobro") VALUES (1,'Alvaro','Fonseca','gijon','gijoon','89652345','536468536','2020-02-02','informatica','uniovi',2000,'72746653E',"pagado","2020-04-02"),
 (2,'Miguel','Rodriguez','llangreu','langreo','2556454','523835684','2020-02-02','informatica','uniovi',2000,'63178588A',"pagado","2020-04-02"),
 (3,'Maria','Berni','el molinon','xixon','12345','12345','2020-02-02','informatica','uniovi',2000,'62810739Q',"pagado","2020-04-02"),
 (4,'Nerea','Granda','Aviles','Ailes','53543','345345345','2020-02-02','informatica','uniovi',2000,'77600235Y',"pagado","2020-04-02"),
 (5,'Frank','Pichon','colloto','colloto','2432342','523824335684','2020-02-02','informatica','uniovi',2000,'32404476Y',"pagado","2020-04-02"),
 (6,'Alvaro','Rodriguez','Xixon','Xixon','75738','7833567','2020-02-02','informatica','uniovi',2001,'01039207K',"pagado","2020-04-02"),
 (7,'Paula','Granda','Aviles','Ailes','35345','34533','2021-02-02','quimica','uniovi',2002,'65151727H',"pagado","2020-04-02"),
 (8,'Laura','Junqueras','Pola de Siero','Siero','534534','435345','2021-02-02','informatica','uniovi',2000,'05891104E',"pagado","2020-04-02"),
 (9,'Adan','Valles','Sotrondio','SMR','3463','3453453','2021-02-02','informatica','uniovi',2000,'74028086X',"pagado","2020-04-02");
...
INSERT INTO "Precolegiado" ("id","nombre","apellidos","dni","direccion","datosCuenta","fechaSolicitudPrecolegiado","titulacion","poblacion","telefono","centro","estadoCobro","fechaCobro") VALUES (1,'Sergio','hndz','23578734P','rafael','453454','2021-04-06','ingenieria','la felguera',666777444,"uniovi","cobrado","2020-02-05"),
