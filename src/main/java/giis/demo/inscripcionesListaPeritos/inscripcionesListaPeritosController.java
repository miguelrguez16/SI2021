...
public class inscripcionesListaPeritosController {
	...
	public void initController() {
		...
		vista.getBtnInscripcionPerito()
				.addActionListener(e -> SwingUtil.exceptionWrapper(() -> generarInscripcionPerito()));
	}
	...
	// idColegiado=modelo.getColegiadoNombre(idColegiado)==null ? -1 :
	// Integer.parseInt(modelo.getColegiadoNombre(idColegiado));
	/*
	 * if(idColegiado!=-1) {
	 * vista.getTFnombre().setText(modelo.getColegiadoNombre(idColegiado));
	 * vista.getTFapellidos().setText(modelo.getColegiadoApellidos(idColegiado));
	 ...
	 * vista.getTFcentro().setText(modelo.getColegiadoCentro(idColegiado));
	 * vista.getTFanio().setText(modelo.getColegiadoAnioT(idColegiado));
	 * vista.getTFdni().setText(modelo.getColegiadoDNI(idColegiado)); } else throw
	 * new ApplicationException("El idColegiado="
	 * +idColegiado+" no existe en nuestra Base de Datos."); }
	 */
